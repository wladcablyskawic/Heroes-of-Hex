...
DUELO.player = function (tile, dir) {
    var that = {},
        direction = dir==undefined?0:dir,
        pos = [tile.column, tile.row], 
        sprite,
        moving = false; 
...
// a game!
function game(tile, dir) {
	if(DUELO.paper!=undefined) DUELO.paper.clear();
    var myPlayer = DUELO.player(tile, dir);
